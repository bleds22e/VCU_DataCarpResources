...
We can also assigngroups of elements of the same type to a particular object. This is a core data structure in R.
...
parentheses are called arguments. Arguments are how we provide the function with bits of informationthe specifics that we give the function about 
...
TODO add in breaks for working on the assignment. Also add some more practice?